...
- Éléments imprimés
  ...
  - Boîte à encastrer (1×)
  - Couvercle supérieur de la boîte à encastrer (1×)
  - Couvercle inférieur de la boîte à encastrer (1×)
...
Utilisez les zones libres du PCB comme appuis et prenez votre temps.
...
paire de cartes Raspberry Pi et Adafruit que vous avez préparée tout à l'heure.
...
Tout d'abord, vous devez vous occuper du haut-parleur. Celui-ci utilise un
...
forme de huit. Prenez votre temps, enroulez serré.

![](images/026.jpg){width=100%}

Prenez alors la boîte principale, la petite boîte ainsi que le haut-parleur.
